    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4">
      ...
      <ResponsiveContainer width="100%" height={260}>
        <ComposedChart data={data} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
          ...
          <YAxis yAxisId="tokens" tick={{ fontSize: 11, fill: '#9ca3af' }} tickLine={false} axisLine={false} tickFormatter={(v: number) => formatTokens(v)} width={50} />
          ...
          <Bar yAxisId="tokens" dataKey="input_tokens" name="Input" fill={COLORS.input} radius={[2, 2, 0, 0]} barSize={16} />
          <Bar yAxisId="tokens" dataKey="output_tokens" name="Output" fill={COLORS.output} radius={[2, 2, 0, 0]} barSize={16} />
          <Bar yAxisId="tokens" dataKey="cache_input_tokens" name="Cache Input" fill={COLORS.cache_input} radius={[2, 2, 0, 0]} barSize={16} />
          <Bar yAxisId="tokens" dataKey="cache_output_tokens" name="Cache Output" fill={COLORS.cache_output} radius={[2, 2, 0, 0]} barSize={16} />
